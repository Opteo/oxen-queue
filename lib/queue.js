const uuid = require('node-uuid') // maybe use built in crypto instead of library?

const db = require('./storage') // make this a module that is passed through the function
