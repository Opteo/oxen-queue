...
const error_messages = {
    ...
    no_mysql_connection: `Must supply mysql_connection argument. It should look something like: const ox = new oxen_queue({ mysql_connection : { host : 'foo.net', password : 'secret'} ... }).`,
}
